 ...
 * Use the [TakeOut.newInstance] factory method to
 * create an instance of this fragment.
 */
class TakeOut : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val recyclerView : RecyclerView=view.findViewById(R.id.take_out_recyclerview)
    ...
    companion object {
         ...
         * @return A new instance of fragment TakeOut.
         */
