...
class Sample : AppCompatActivity(), OnMapReadyCallback {
    private lateinit var mMap: GoogleMap
    /*val scrollViews : ScrollView =findViewById(R.id.menu_choicescroll)
    val layout1 : LinearLayout=findViewById(R.id.review_ll_chef_detail)
    val menu_list : LinearLayout=findViewById(R.id.menu_list_ll)
    val layout2 : LinearLayout=findViewById(R.id.review_ll)*/
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ll_menu_choice_chef.setOnClickListener {
            ...
            menu_recyclerview.layoutManager=LinearLayoutManager(applicationContext,LinearLayoutManager.VERTICAL,false)

            val menuListModel=ArrayList<Menu_List_Model>()
            menuListModel.add(Menu_List_Model(R.drawable.bg_food_detail,"Green capsicum pepped up with Cheese and spices","22.00","2"))
            menuListModel.add(Menu_List_Model(R.drawable.img_menu2,"Green capsicum pepped","23.00","1"))
            menuListModel.add(Menu_List_Model(R.drawable.img_menu3,"Green capsicum with Cheese and spices","24.00","3"))
            menuListModel.add(Menu_List_Model(R.drawable.img_menu1,"pepped up with Cheese and spices","21.00","4"))
            menuListModel.add(Menu_List_Model(R.drawable.bg_food_detail,"Cheese and spices with Green capsicum","22.00","3"))
            menuListModel.add(Menu_List_Model(R.drawable.img_menu2,"pepped up Green capsicum with Cheese and spices","23.00","1"))
            ...
            ll_dine_in.setOnClickListener {
                ...
                takeout_txt.setTextColor(resources.getColor(R.color.Light_black))
                ...
                delivery_txt.setTextColor(resources.getColor(R.color.Light_black))
            ...
            ll_takeout.setOnClickListener {
                ...
                dinein_txt.setTextColor(resources.getColor(R.color.Light_black))
